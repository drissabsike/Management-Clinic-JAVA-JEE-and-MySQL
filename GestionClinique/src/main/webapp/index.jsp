...
.banner_part {
  ...
  position: relative;
  overflow: hidden;
  background-image: url(file:///C:/Users/HP/Desktop/GestionClinique/src/main/webapp/statistique/coronavirus-17.jpg);
  background-repeat: no-repeat;
                    ...
                    <a class="navbar-brand" href="index.html"> <img src="file:///C:/Users/HP/Desktop/GestionClinique/src/main/webapp/img/logo.png" alt="logo"> </a>
                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-center"
                            ...
                            <ul class="navbar-nav align-items-center">
                                    ...
                                    <li>
                                    <a class="nav-link"    href="list"><b>Consulter la liste des Patients</b></a>     
                                         
                               
                                    <a class="nav-link"   href="ajout_rec.jsp"><b>Ajouter une réceptionniste </b></a>
                                    
                                    
                           
                                    <a class="nav-link" href="listRec.jsp"><b>Afficher les  réceptionniste </b></a>
                                    
                                    
                             
                                    <a  class="nav-link"  href="ajout_med.jsp"> <b>Ajouter un nouvelle Medcin </b></a>
                                    
                                    
                             
                                    <a class="nav-link" href="listMedcins.jsp"> <b>Afficher les Medcins </b></a>
            ...
            <div class="row align-items-center">
                <div class="col-lg-5 col-xl-5">
                    ...
                    <div class="about_us_img">
                        <img src="file:///C:/Users/HP/Desktop/GestionClinique/src/main/webapp/img/reservation.png" " alt="">
            ...
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="about_us_text">
                        <h2>Logiciel de gestion de clinique médicale et de dossier patient</h2>
                        <p>Dossiers médicaux électroniques
Nous vous permettons une gestion complète des dossiers médicaux électroniques pour toute votre équipe. Information, suivi de traitement, documents et bilans médicaux. Tout est réuni au même endroit et accessible instantanément !.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    <div class="section_tittle text-center">
                        <h2> La Gestion Globale De Votre Clinique</h2>
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="single_blog_item">
                        <div class="single_blog_img">
                            <img src="file:///C:/Users/HP/Desktop/GestionClinique/src/main/webapp/statistique/stat1.jpg" alt="doctor">
                        ...
                        <div class="single_text">
                            <div class="single_blog_text">
                                <h3>La Gestion du suivie des patients</h3>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="single_blog_item">
                        <div class="single_blog_img">
                            <img src="file:///C:/Users/HP/Desktop/GestionClinique/src/main/webapp/statistique/stat3.jpg" alt="doctor">
                            <div class="social_icon">
                                <ul>
                                    <li><a href="#"> <i class="ti-facebook"></i> </a></li>
                                    <li><a href="#"> <i class="ti-twitter-alt"></i> </a></li>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="single_blog_item">
                        <div class="single_blog_img">
                            <img src="file:///C:/Users/HP/Desktop/GestionClinique/src/main/webapp/statistique/stat4.jpg" alt="doctor">
                            <div class="social_icon">
                                <ul>
                                    <li><a href="#"> <i class="ti-facebook"></i> </a></li>
                                    <li><a href="#"> <i class="ti-twitter-alt"></i> </a></li>
                        ...
                        <div class="single_text">
                            <div class="single_blog_text">
                                <h3>Le Cycle du vie de votre Clinique</h3>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="single_blog_item">
                        <div class="single_blog_img">
                            <img src="file:///C:/Users/HP/Desktop/GestionClinique/src/main/webapp/statistique/statpng.png" alt="doctor">
                            <div class="social_icon">
                                <ul>
                                    <li><a href="#"> <i class="ti-facebook"></i> </a></li>
                                    <li><a href="#"> <i class="ti-twitter-alt"></i> </a></li>
