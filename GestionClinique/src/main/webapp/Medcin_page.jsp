...
.banner_part {
  ...
  position: relative;
  overflow: hidden;
  background-image: url(file:///C:/Users/HP/Desktop/Projet%20JEE/GestionClinique/src/main/webapp/img/reservation_bg.png);
  background-repeat: no-repeat;
                    ...
                    <a class="navbar-brand" href="index.html"> <img src="file:///C:/Users/HP/Desktop/GestionClinique/src/main/webapp/img/logo.png" alt="logo"> </a>
                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-center"
                            ...
                            <ul class="navbar-nav align-items-center">
                                    ...
                                    <li>
                                    <a  class="btn_2 d-none d-lg-block" href="medcineProfile.jsp">Consulter Votre Profile</a> 
                                                           
                                     <a  class="btn_2 d-none d-lg-block"  href="show_rd_medcin.jsp">Afficher Votre Liste des Rendez-Vous</a>
                                     
                                     <a class="btn_2 d-none d-lg-block"  href="creat_cons.jsp">Ajouter Une Nouvelle Consultation</a>
                                     
                                     <a class="btn_2 d-none d-lg-block"  href="showCons.jsp">Afficher la Liste des Consultations</a>
                                     
                                     <a class="btn_2 d-none d-lg-block""  href="dossieM.jsp">Ajouter Un nouveaux Dossier Medical</a>
                                     
                                     <a class="btn_2 d-none d-lg-block"  href="showdossieM.jsp">Afficher la liste des dossiers médicaux</a>
                                     
                                     <a class="btn_2 d-none d-lg-block"   href="show_all_patients.jsp">Afficher La liste de vos  Patients </a>
                                     
                                     <a class="btn_2 d-none d-lg-block"  href="login.jsp"><span class="glyphicon glyphicon-log-in"> Déconnecté</span></a>
